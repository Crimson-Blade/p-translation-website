...
const Navbar = () => {
  return (
    <header className="sticky top-0  flex flex-col item-start justify-between mx-auto z-20 xl:items-center">
      <div className="flex w-full bg-slate-800 px-2">
        <motion.div
          initial={{
            x: 500,
            opacity: 0,
        ...
        >
          ...
          <SocialIcon
            ...
            bgColor="transparent"
          />
          <p className="uppercase hidden md:inline-flex my-auto text-sm text-gray-400 hover:text-slate-900 hover:underline duration-200">
            Get In Touch!
          </p>
          </div>
          <div>
      ...
      >
        ...
        <Link
          to="/AboutUs"
          className="uppercase px-4 hidden md:inline-flex my-auto text-sm text-gray-400 hover:text-slate-900 hover:underline duration-200"
        >
          About
        </Link>
        <Link
